...
# $Header: /var/cvsroot/gentoo-x86/net-wireless/madwifi-ng/madwifi-ng-0.1531.20060427.ebuild,v 1.1 2006/04/27 16:34:52 brix Exp $
...
src_unpack() {
	...
	cd ${S}
	epatch ${FILESDIR}/madwifi-ng-r1526.patch
